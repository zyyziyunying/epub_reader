...
class NavigationBuilder {
  ...
  NavigationBuildResult build({
    ...
    final navItems = _buildNavItems(documents: documents, tocItems: tocItems);

    return NavigationBuildResult(
      documents: documents,
      tocItems: tocItems,
      navItems: navItems,
      hasPhase2OnlyToc: _hasPhase2OnlyToc(tocItems),
  ...
  List<DocumentNavItem> _buildNavItems({
  ...
  bool _hasPhase2OnlyToc(List<TocItem> tocItems) {
