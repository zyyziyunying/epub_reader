...
void main() {
  group('NavigationBuilder', () {
    ...
    test('uses usable spine order and keeps linear false items in document order', () {
    ...
    test('falls back to TOC order and appends remaining html files alphabetically', () {
      final result = builder.build(
        bookId: 'book-2',
        source: NavigationSourceBook(
          opfBaseDir: 'OPS',
          ...
          manifestItems: [
            _manifestItem('missing', 'Text/missing.xhtml'),
          ],
          spineItems: [
            _spineItem('missing'),
          ],
    ...
    test('normalizes paths and keeps the lexicographically smallest html source', () {
      final result = builder.build(
        bookId: 'book-3',
        source: NavigationSourceBook(
          opfBaseDir: 'OPS',
          ...
          manifestItems: [
            _manifestItem('chapter', './Text/ch%201.xhtml'),
          ],
          spineItems: [
            _spineItem('chapter'),
          ],
    ...
    test('builds nav titles from the first eligible TOC item and flags phase 2 only toc', () {
      final result = builder.build(
        bookId: 'book-4',
        source: NavigationSourceBook(
          opfBaseDir: 'OPS',
          ...
          manifestItems: [
            _manifestItem('chapter', 'Text/ch1.xhtml'),
          ],
          spineItems: [
            _spineItem('chapter'),
          ],
